...
echo '<div style="direction:ltr;text-align:left;border:1px solid black; padding:5px; margin:10px; background-color:#DDEEFF; color:#000000; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">The federal polytechnic, Kaura Namoda came into existence in June 1983 vide Decree No. 33 of 25th July, 1979 as amended in 1985.
<h1>VISION STATEMENT</h1>
A well-motivated result oriented Institution committed to producing qualitative human capital for self-reliance and national development.
<h1>MISSION STATEMENT</h1>
To produce skilled graduates for self-reliance and national development.
<h1>MOTTO</h1>
Skill for Technological Emancipation.</div>'.K_NEWLINE;
