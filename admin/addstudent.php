...
$ema=new formvalidation($r,$epattern,$em);
$cl=new formvalidation($c,$upattern,$cla);
$osu=$su->validate1();
$ofu=$fiu->validate1();
$oou=$ou->validate1();
$oem=$ema->validate1();
...
<div class="row">
<div class="col-md-10">
<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Enter A New Student Record</h1>
</div>
<div class="col-md-2">
...
<div class="list-group">
  ...
  <a href="student.php" class="list-group-item  main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>Add/Edit Student<span class="badge">12</span></a>
...
<div class="panel panel-default">
  <div class="panel-heading main-color-bg">
    <h3 class="panel-title">Enter New Student Record</h3>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
		...
		<input type="email" class="form-control" name="regname" placeholder="Email" />
		</div>
		 <div class="form-group">
