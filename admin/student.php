...
<div class="row">
<div class="col-md-10">
<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Student Profile Page</h1>
</div>
<div class="col-md-2">
<a class="btn btn-danger" href="addstudent.php">Add Student</a>
</div>
</div>
</div>
...
<div class="panel panel-default">
  <div class="panel-heading main-color-bg">
    <h3 class="panel-title">Student Page</h3>
  </div>
  ...
  <br />
   ...
   $qury=$db->query("SELECT * FROM student");//select from dtable(assigment) table
		if($qury->num_rows)
		{
		?>
