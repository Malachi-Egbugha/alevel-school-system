...
<li class="active"><a href="lecturer.php">Add/Edit Lecturer</a></li>
...
<div class="row">
<div class="col-md-10">
<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Lecturer Profile Page</h1>
</div>
<div class="col-md-2">
<a class="btn btn-danger" href="addlecturer.php">Add Lecturer</a>
</div>
</div>
</div>
...
<div class="panel panel-default">
  <div class="panel-heading main-color-bg">
    <h3 class="panel-title">Lecturer Page</h3>
  </div>
 ...
 <?php
   ...
   $qury=$db->query("SELECT * FROM staff");//select from dtable(assigment) table
		if($qury->num_rows)
		{
		?>
