...
<div class="row">
<div class="col-md-12">
<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Dashborad <small>E-Learning</small></h1>
</div>
</div>
</div>
...
<div class="list-group">
  ...
  <a href="calender.php" class="list-group-item "><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Calender</a>
</div>
<div class="well">
...
<div class="panel panel-default">
  <div class="panel-heading main-color-bg">
    <h3 class="panel-title">Kaura Namoda Polytechnic</h3>
  </div>
  <div class="panel-body">
    <div class="col-md-3 dash-box">
	<div class="well">
	<h2><span class="glyphicon glyphicon-user" aria-hidden="true">203</h2>
	<h4>Users</h4>
	</div>
	</div>
	...
	<div class="col-md-3 dash-box">
	<div class="well">
	<h2><span class="glyphicon glyphicon-list-alt" aria-hidden="true">12</h2>
	<h4>Pages</h4>
	</div>
	</div>
	...
	<div class="col-md-3 dash-box">
	<div class="well">
	<h2><span class="glyphicon glyphicon-pencil" aria-hidden="true">33</h2>
	<h4>Post</h4>
	</div>
	</div>
	...
	<div class="col-md-3 dash-box">
	<div class="well">
	<h2><span class="glyphicon glyphicon-stats" aria-hidden="true">12,334</h2>
	<h4>Visitor</h4>
	</div>
	</div>
  </div>
